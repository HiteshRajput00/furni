                                ...
                                @if (session()->has('id'))
                                    <div class="input-group w-75 couponcode-wrap">
                                        <select class="form-select" aria-label="Default select example"
                                            id="input" name="code">
                                            <option value="{{ session('id')}}" selected> {{ session('name') }}
                                            </option>
                                            @foreach ($coupon as $c)
                                    ...
                                    <a id="remove" class="btn btn-black btn-sm">X</a>
                                ...
                                @if (!session('id'))
                                    <table class="table site-block-order-table mb-5">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td id="after" class="text-black font-weight-bold"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td id="final" class="text-black font-weight-bold">
                                                    <strong>${{ $total }}</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table site-block-order-table mb-5">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td id="total" class="text-black"><del>${{ $total }}</del>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="after" class="text-black font-weight-bold">after discount
                                                </td>
                                                <td id="discount" class="text-black">{{ session('discount') }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Order Total</strong>
                                                </td>
