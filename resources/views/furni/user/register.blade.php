...
<head>
    ...
    <link href="{{ url('/asset/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css') }}"
        rel="stylesheet">
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <h4 style="color: black">Have account ?<a href="/furni/login"
                                        class="btn btn-primary">Sign in </a> </h4>
                                </p>
                            </div>
                        </div>
                    </div>
