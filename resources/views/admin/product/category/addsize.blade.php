...
<head>
    ...
    <link href="{{url('/admin/css/input.css')}}" rel="stylesheet">
                        ...
                        <div class="form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5">
                                    <a class="text-center" href="/home"> <h4>add size</h4></a>
            
                                    <form class="mt-5 mb-5 login-input" method="post" action="/addsize" >
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="00x00" name="size">
                                            @if($errors->has('size'))
