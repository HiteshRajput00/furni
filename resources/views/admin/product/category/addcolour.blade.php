...
<head>
    ...
    <link href="{{ url('/admin/css/colourfeild.css') }}" rel="stylesheet">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    <form class="mt-5 mb-5 login-input" method="post" action="/addcolour">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="" placeholder="enter colour"
                                                name="colour">
                                        ...
                                        <div class="form-group">
                                            <input type="color" id="colourfeild" placeholder="enter colour"
                                                name="colourcode">
