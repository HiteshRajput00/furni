                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" method="post" action="/store">
                                    ...
                                    @enderror
                                    <button class="btn login-form__btn submit w-100" type="submit" name="store" >Sign in</button>
                                </form>
                                    <p class="mt-5 login-form__footer">Have account <a href="/home" class="text-primary">Sign Up </a> now</p>
                                    </p>
                                </div>
                            </div>
                        </div>
